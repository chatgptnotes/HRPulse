...
import salaryFillRoutes from './routes/salaryFill';
import himsSyncRoutes from './routes/himsSync';
...
app.use('/api/salary-fill', salaryFillRoutes);
app.use('/api/salary-fill', himsSyncRoutes);
